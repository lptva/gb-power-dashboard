...
- **The BESS calculator's toll/financing block is assumption arithmetic** laid over the observed merchant anchor – no lender downside case, no balloon or refinancing, no tax. Toll price, gearing and cost of debt are figures the user types, not figures the dashboard measured.