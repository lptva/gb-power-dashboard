...
3. Fetch a zone with `python3 etl/fetch_entsoe.py --zone FR --days 30`, or let the scheduled refresh keep all seven topped up (zone history accumulates append-only from 31 May 2026).
